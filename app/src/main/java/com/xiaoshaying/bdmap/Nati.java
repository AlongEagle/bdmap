    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "如有意见和建议 请点击右侧", Snackbar.LENGTH_LONG)
                        .setAction("联系居保中心", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Uri uri = Uri.parse("smsto:18856637970");
                                Intent it = new Intent(Intent.ACTION_SENDTO, uri);
                                it.putExtra("sms_body", "请写明您的意见和建议，我们将尽力采纳，谢谢合作！");
                                startActivity(it);
